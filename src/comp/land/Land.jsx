    ...
    <div className="landing_page" ref={homeref}>
      ...
      <section className="timer_sec" ref={stars.ref}>
        ...
        <div className="about_section custom-background">
          ...
          <p>
            "Welcome to <HighlightText text={"AVISHKAAR"} />, a national-level hackathon dedicated to harnessing innovation and technology to tackle real-time challenges in India's rural and urban communities. This event unites creative minds, tech enthusiasts, and problem solvers from across the country to collaborate on solutions that can make a positive societal impact. Aavishkar's primary mission is to offer students a unique platform to address pressing issues in both rural and urban contexts by nurturing innovative solutions. Focusing on themes like digital empowerment, agriculture, healthcare, education, sustainability, and more, we strive to ignite meaningful change in our nation."
          </p>
        </div>
